                ...
                <div className="col-md-4">
                  ...
                  {players.map((player, index) => (
                    <div key={`player-${player.player_id}-${index}`}
                         className="card card-body p-2 results-card" onClick={() => handlePlayerClick(player.playerId)}>
                ...
                <div className="col-md-4">
                  ...
                  {clubs.map((club, index) => (
                    <div key={`club-${club.club_id}-${index}`}
                         className="card card-body p-2 results-card" onClick={() => handleClubClick(club.clubId)}>
                ...
                <div className="col-md-4">
                  ...
                  {competitions.map((competition, index) => (
                    <div key={`competition-${competition.competition_id}-${index}`}
                         className="card card-body p-2 results-card" onClick={() => handleCompetitionClick(competition.competitionId)}>
